...
@Autonomous
@Disabled
public class A4_LeftMediumRegionals extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory one = drive.trajectoryBuilder(start)
                ...
                .splineTo(new Vector2d(18, 13), Math.toRadians(-175))
                .build();

        Trajectory two = drive.trajectoryBuilder(one.end())
                .lineToLinearHeading(new Pose2d(59, 13, toRadians(-180)))
        ...
        Trajectory three = drive.trajectoryBuilder(two.end())
                .lineToLinearHeading(new Pose2d(30, 12, toRadians(-180)))
        ...
        Trajectory twelve3 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(12, 15, toRadians(-180)))
        ...
        Trajectory twelve2 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(35, 15, toRadians(-180)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = -150;
                    turretTarget = 0;
                    liftKp = 0.002;
        ...
        Trajectory twelve1 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(58, 15, toRadians(-180)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = -150;
                    turretTarget = 0;
                    liftKp = 0.002;
