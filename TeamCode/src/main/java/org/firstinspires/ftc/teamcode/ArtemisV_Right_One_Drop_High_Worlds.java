...
@Autonomous
public class ArtemisV_Right_One_Drop_High_Worlds extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory one = drive.trajectoryBuilder(start)
                ...
                .splineTo(new Vector2d(-20, 37), Math.toRadians(0))
                .splineTo(new Vector2d(-8, 30), Math.toRadians(-40))
                .build();

        Trajectory two = drive.trajectoryBuilder(one.end())
                .lineToLinearHeading(new Pose2d(-16, 37, toRadians(0)))
        ...
        Trajectory twelve3 = drive.trajectoryBuilder(two.end())
                .lineToLinearHeading(new Pose2d(-63, 37, toRadians(0)))
        ...
        Trajectory twelve2 = drive.trajectoryBuilder(two.end())
                .lineToLinearHeading(new Pose2d(-39, 37, toRadians(0)))
                .addDisplacementMarker(6, () -> {
                    liftTarget = -150;
                    turretTarget = 0;
                    liftKp = 0.002;
