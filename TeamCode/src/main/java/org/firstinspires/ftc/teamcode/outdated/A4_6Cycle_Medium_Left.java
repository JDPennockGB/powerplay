...
@Autonomous
@Disabled
public class A4_6Cycle_Medium_Left extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory one = drive.trajectoryBuilder(start)
                ...
                .splineTo(new Vector2d(19, 12), Math.toRadians(-180))
                .build();
        ...
        Trajectory five = drive.trajectoryBuilder(four.end())
                .lineToLinearHeading(new Pose2d(35, 14, toRadians(-180)))
                .addDisplacementMarker(8, () -> {
                    liftTarget = 540;
                    turretTarget = -975;
                    liftKp = 0.012;
        ...
        Trajectory ten = drive.trajectoryBuilder(nine.end())
                .lineToLinearHeading(new Pose2d(60, 14, toRadians(-180)))
                .addDisplacementMarker(1, () -> {
                    liftTarget = 10;
                    turretTarget = -25;
                    liftKp = 0.0012;
        ...
        Trajectory twelve2 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(36, 24, toRadians(-180)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 10;
                    turretTarget = 0;
                    liftKp = 0.0012;
        ...
        Trajectory twelve3 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(13, 12, toRadians(-180)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 10;
                    turretTarget = 0;
                    liftKp = 0.0012;
