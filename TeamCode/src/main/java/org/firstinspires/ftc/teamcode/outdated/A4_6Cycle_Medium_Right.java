...
@Autonomous
@Disabled
public class A4_6Cycle_Medium_Right extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory one = drive.trajectoryBuilder(start)
                ...
                .splineTo(new Vector2d(-18, 13), Math.toRadians(0))
                .build();
        ...
        Trajectory three = drive.trajectoryBuilder(two.end())
                .lineToLinearHeading(new Pose2d(-35, 14, toRadians(0)))
        ...
        Trajectory twelve1 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-12, 13, toRadians(0)))
        ...
        Trajectory twelve2 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-35, 24, toRadians(0)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 10;
                    turretTarget = 0;
                    liftKp = 0.0012;
