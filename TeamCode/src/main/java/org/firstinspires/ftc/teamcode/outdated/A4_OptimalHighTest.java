...
@Autonomous
@Disabled
public class A4_OptimalHighTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory one = drive.trajectoryBuilder(start)
                ...
                .addTemporalMarker(1.5, () -> LV.setPosition(0.7))
                .addTemporalMarker(1.5, () -> RV.setPosition(0.3))
                .addDisplacementMarker(40, () -> {
                    liftTarget = 820;
                    turretTarget = -480;
                    liftKp = 0.012;
                })
                .splineTo(new Vector2d(-18, 13), Math.toRadians(-5))
                .build();
        ...
        Trajectory three = drive.trajectoryBuilder(two.end())
                .lineToLinearHeading(new Pose2d(-32, 11, toRadians(0)))
                .addDisplacementMarker(8, () -> {
                    liftTarget = 820;
                    turretTarget = -900;
                    liftKp = 0.012;
                })
                .addTemporalMarker(0.5, () -> LV.setPosition(0.75))
                .addTemporalMarker(0.5, () -> RV.setPosition(0.25))
                .build();
        ...
        Trajectory five = drive.trajectoryBuilder(four.end())
                .lineToLinearHeading(new Pose2d(-31, 11, toRadians(0)))
                .addDisplacementMarker(8, () -> {
                    liftTarget = 820;
                    turretTarget = -880;
                    liftKp = 0.012;
        ...
        Trajectory eight = drive.trajectoryBuilder(seven.end())
                .lineToLinearHeading(new Pose2d(-58.5, 14, toRadians(0)))
                .addDisplacementMarker(5, () -> {
                    liftTarget = 35;
                    turretTarget = 0;
                    liftKp = 0.002;
        ...
        Trajectory nine = drive.trajectoryBuilder(eight.end())
                .lineToLinearHeading(new Pose2d(-30, 12, toRadians(0)))
                .addDisplacementMarker(8, () -> {
                    liftTarget = 820;
                    turretTarget = -880;
                    liftKp = 0.012;
        ...
        Trajectory twelve1 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-12, 15, toRadians(0)))
        ...
        Trajectory twelve2 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-35, 15, toRadians(0)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 0;
                    turretTarget = 0;
                    liftKp = 0.002;
        ...
        Trajectory twelve3 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-58, 15, toRadians(0)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 0;
                    turretTarget = 0;
                    liftKp = 0.002;
