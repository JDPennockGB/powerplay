...
@Autonomous
@Disabled
public class A4_6Cycle_Right extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Trajectory one = drive.trajectoryBuilder(start)
                ...
                .splineTo(new Vector2d(-19, 13), Math.toRadians(-5))
                .build();

        Trajectory two = drive.trajectoryBuilder(one.end())
                .lineToLinearHeading(new Pose2d(-59, 12, toRadians(0)))
        ...
        Trajectory three = drive.trajectoryBuilder(two.end())
                .lineToLinearHeading(new Pose2d(-21, 12, toRadians(0)))
        ...
        Trajectory eleven = drive.trajectoryBuilder(ten.end())
                .lineToLinearHeading(new Pose2d(-20, 13, toRadians(0)))
                .addDisplacementMarker(8, () -> {
                    liftTarget = 820;
                    turretTarget = -540;
                    liftKp = 0.012;
        ...
        Trajectory twelve1 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-11, 13, toRadians(0)))
        ...
        Trajectory twelve2 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-35, 13, toRadians(0)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 0;
                    turretTarget = 0;
                    liftKp = 0.002;
        ...
        Trajectory twelve3 = drive.trajectoryBuilder(eleven.end())
                .lineToLinearHeading(new Pose2d(-58, 13, toRadians(0)))
                .addDisplacementMarker(3, () -> {
                    liftTarget = 0;
                    turretTarget = 0;
                    liftKp = 0.002;
